...
if __name__=='__main__':
    ...
    RefData=PreProcessGPR(X_data,lambda_=5e-3,max_iter=2000,rank=2)
    ...
    pyplot.figure()
    pyplot.imshow(X_data-RefData,extent=(0,1,0,1),vmin=0.1*np.min(X_data),vmax=0.1*np.max(X_data))
    pyplot.axis('off')